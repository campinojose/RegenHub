    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Ingresa tus credenciales de profesional</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg shadow-md hover:shadow-lg transition duration-200 disabled:opacity-50 mt-2"
          >
            {loading ? 'Iniciando sesión...' : 'Ingresar al Consultorio'}
          </button>
        </form>
      </div>
    </div>
